...
\begin{figure}[ht]
\begin{center}
  \subfloat[]{\includegraphics[width=0.32\textwidth]{figures/shortest2}}
  \hspace{0.02cm}
  \subfloat[]{\includegraphics[width=0.32\textwidth]{figures/shortest3}}
  \hspace{0.02cm}
  \subfloat[]{\includegraphics[width=0.32\textwidth]{figures/shortest8}}
\end{center}
